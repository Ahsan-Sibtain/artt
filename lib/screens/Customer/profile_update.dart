  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Profile Update", style: TextStyle(fontSize: height / 50, color: Colors.white),), //TODO: USER NAME
        centerTitle: true,
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text("Personal Information", style: TextStyle(color: Colors.black, fontSize: height/50, fontWeight: FontWeight.w500)),
                  SizedBox(
                    height: height/60,
                  ),
                  SizedBox(
