...
class _visitorArtDetailsState extends State<visitorArtDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    String views = "42555";
    String ratings = "4.2";
    String description = "it has been the first i have done in some time now and with it if you only want to underline part of the text then you need to use Text.rich() (or a RichText widget) and break the string into TextSpans that you can add a style to ";
              ...
              children: [
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {},
                      child: Icon(EvaIcons.heart, color: Colors.red, size: height/45),
                    ),
                    Text(
                      "$likes",
                    ), //TODO Likes
                    ...
                    Icon(EvaIcons.eyeOutline, color: Colors.black, size:  height/45),
                    Text("("),
                    Text(
                      "$views",
                    ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('$description', //TODO: Show Story About art
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: height / 60,
